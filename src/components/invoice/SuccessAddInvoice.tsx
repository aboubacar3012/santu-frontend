  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-[400px]">
      <motion.div
        ...
        className="h-min py-10 px-6 gap-4 flex flex-col items-center text-black bg-white shadow-lg rounded-xl m-4 border border-gray-100 max-w-md w-full"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        >
          Pour finaliser la facture, veuillez sélectionner l'une des options
          ci-dessous.
        </motion.p>
