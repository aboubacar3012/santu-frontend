        ...
        <div className="w-1/2 h-min py-2 gap-4  flex flex-col text-black bg-white  rounded-lg ">
              ...
              <div className="w-full flex flex-col gap-1 p-6">
                <div className="relative h-11 w-full min-w-[200px]">
                  ...
                  <input
                    ...
                    id="title"
                    className="border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez l'url du logo" />
                </div>
              </div>
            )}
          ...
          <div className="w-full flex gap-1 px-6">
            <div className="w-full flex flex-col">
              <div className="w-full min-w-[200px]">
                ...
                <input value={firstName} onChange={(e) => setFirstName(e.target.value)} type="text" id="firstName" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez le prénom" required />
              </div>
            </div>
            <div className="w-full flex flex-col">
              <div className="w-full min-w-[200px]">
                ...
                <input value={lastName} onChange={(e) => setLastName(e.target.value)} type="text" id="lastName" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez le nom" required />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1 px-6">
            <div className=" w-full min-w-[200px]">
              ...
              <input value={address} onChange={(e) => setAddress(e.target.value)} type="text" id="address" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez votre adresse" required />
            </div>
          </div>
        ...
        <div className="w-1/2 h-min py-2 gap-2 flex flex-col text-black bg-white  rounded-lg ">
          <div className="flex flex-col gap-1 px-6">
            <div className=" w-full min-w-[200px]">
              ...
              <input disabled={true} value={email} onChange={(e) => setEmail(e.target.value)} type="email" id="email" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" required />
            </div>
          </div>
          <div className="flex flex-col gap-1 px-6">
            <div className=" w-full min-w-[200px]">
              <label htmlFor="actualPassword" className="block mb-2 text-sm font-medium text-black">
                Mot de passe actuel
              </label>
              <input value={actualPassword} onChange={(e) => setActualPassword(e.target.value)} type="text" id="actualPassword" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez le mot de passe actuel" required />
            </div>
          </div>
          <div className="flex flex-col gap-1 px-6">
            <div className=" w-full min-w-[200px]">
              ...
              <input value={newPassword} onChange={(e) => setNewPassword(e.target.value)} type="text" id="newPassword" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Entrez le nouveau mot de passe" required />
            </div>
          </div>
          <div className="flex flex-col gap-1 px-6">
            <div className=" w-full min-w-[200px]">
              <label htmlFor="confirmNewPassword" className="block mb-2 text-sm font-medium text-black">
                Confirmer le mot de passe
              </label>
              <input value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} type="text" id="confirmNewPassword" className=" border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5" placeholder="Confirmez le nouveau mot de passe" required />
            </div>
          </div>
          <button onClick={() => { }}
            className="mx-6 w-min px-6 font-semibold bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700"
